...
function AutomatedAnalysisPage() {
  ...
  const handleRetry = useCallback(() => {
    ...
    // Automatically retry the workflow with exponential backoff
    if (email && validateEmail(email)) {
      console.log('🔄 Retrying workflow with exponential backoff...');
      handleStartWorkflow();
    }
  }, [email, validateEmail, handleStartWorkflow]);
  ...
  const handleDownloadReport = useCallback(() => {
    ...
    const report = {
      ...
      summary: {
        ...
        rulesChecked: workflowResults.analysisResults?.rulesChecked || 371, // Updated to reflect actual MISRA rule count
