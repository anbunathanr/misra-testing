...
|---------|-------------|------|------|
| Rule 17.7 | The value returned by function printf having non-void return type is not used | temp_test.c | 3 |
...
- **Rule ID:** Rule 17.7
- **Description:** The value returned by function printf having non-void return type is not used
- **Source Location:**
  - **File:** temp_test.c
  - **Line:** 3
