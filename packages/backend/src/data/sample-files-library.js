...
async function initializeSampleFilesLibrary() {
    const { SampleFileService } = await Promise.resolve().then(() => __importStar(require('../services/sample-file-service')));
